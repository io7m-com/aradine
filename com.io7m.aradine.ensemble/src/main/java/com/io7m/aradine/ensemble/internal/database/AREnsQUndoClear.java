...
public enum AREnsQUndoClear
  implements AREnsQUndoClearType, ARDBQueryProviderType
{
  /**
   * Clear the undo stack.
   */
  ...
  {
    return AREnsQUndoClearType.class;
  }

  @Override
  public AREnsQUndoClearType queryInstance()
  {
    return this;
  }
