...
/**
 * Peek a record from the redo stack.
 */

public enum AREnsQRedoPeek
  implements AREnsQRedoPeekType, ARDBQueryProviderType
{
  /**
   * Peek a record from the redo stack.
   */
  ...
  {
    return AREnsQRedoPeekType.class;
  }

  @Override
  public AREnsQRedoPeekType queryInstance()
  {
    return this;
  }
