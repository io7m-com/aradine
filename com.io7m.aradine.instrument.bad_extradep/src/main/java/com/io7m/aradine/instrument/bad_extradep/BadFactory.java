...
package com.io7m.aradine.instrument.bad_extradep;
...
/**
 * A bad instrument factory.
 */

public final class BadFactory implements ARI1InstrumentFactoryType
{
  /**
   * A bad instrument factory.
   */
  ...
  public InputStream openInstrumentDescription()
  {
    return BadFactory.class.getResourceAsStream(
      "/com/io7m/aradine/instrument/bad_extradep/internal/instrument.json"
    );
  }
  ...
  {
    throw new IllegalStateException(IOUtils.byteArray().toString());
  }
}
