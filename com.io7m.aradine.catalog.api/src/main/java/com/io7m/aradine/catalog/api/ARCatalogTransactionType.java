...
/**
 * The type of catalog transactions.
 */

public interface ARCatalogTransactionType
  extends AutoCloseable
{
  ...
  <P, R, Q extends ARCatalogQueryType<P, R>> Q query(
    Class<Q> queryType)
  ...
  default <P, R, Q extends ARCatalogQueryType<P, R>> R execute(
