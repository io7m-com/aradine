...
public enum ARIJ1ListStringDefinition
  implements SjDefinitionProviderType
{
    ...
    final SjGeneratorConfiguration configuration)
  {
    return () -> {
      ...
      final var items = mapper.createObjectNode();
      items.put("$ref", "#/$defs/String");

      final var object = mapper.createObjectNode();
      object.put("type", "array");
      object.put("description", "An array of strings.");
