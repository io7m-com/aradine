...
import static com.io7m.aradine.catalog.api.ARCatalogTransactionCloseBehavior.ON_CLOSE_DO_NOTHING;

/**
 * A catalog connection.
 */

public interface ARCatalogConnectionType
  extends AutoCloseable
{
  ...
  ARCatalogTransactionType openTransaction(
    ARCatalogTransactionCloseBehavior closeBehavior)
    throws ARCatalogException;
