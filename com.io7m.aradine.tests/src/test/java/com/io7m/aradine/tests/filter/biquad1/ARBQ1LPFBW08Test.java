...
public final class ARBQ1LPFBW08Test
{
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/lpf8bw_cutoff_0.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/lpf8bw_cutoff_03125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/lpf8bw_cutoff_0125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/lpf8bw_cutoff_025.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/lpf8bw_cutoff_05.properties");
  }
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/biquad1/lpf8bw_cutoff_05.properties",
        inputSample.sampleRate()
      );
