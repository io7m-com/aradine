...
public enum AREnsQPortDelete
  implements AREnsQPortDeleteType, ARDBQueryProviderType
{
  /**
   * Delete a port.
   */
  ...
  {
    return AREnsQPortDeleteType.class;
  }

  @Override
  public AREnsQPortDeleteType queryInstance()
  {
    return this;
  }
    ...
    throws ARException
  {
    ...
    try (var st = connection.prepareStatement(QUERY_TEXT)) {
      final var portId = port.toString();
