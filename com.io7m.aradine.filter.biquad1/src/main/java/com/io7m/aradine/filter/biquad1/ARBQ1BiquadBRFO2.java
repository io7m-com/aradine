...
/**
 * <p>A simple biquad band-reject filter of order 2 (Two zeroes, two poles).</p>
 *
 * @see "https://www.earlevel.com/main/2012/11/26/biquad-c-source-code/"
 */

public final class ARBQ1BiquadBRFO2 implements ARBQ1BiquadWithQType
{
  private double a0;
  private double a1;
  private double a2;
