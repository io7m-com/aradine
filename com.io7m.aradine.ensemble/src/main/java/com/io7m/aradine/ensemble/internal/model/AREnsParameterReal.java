...
public final class AREnsParameterReal
  implements AREnsParameterType
{
  private final AREnsInstrumentContext context;
  private final ARParameterDescriptionReal description;
  ...
  public AREnsParameterReal(
    final AREnsInstrumentContext inContext,
    final ARParameterDescriptionReal inDescription)
  {
    this.context =
  ...
  @Override
  public ARParameterDescriptionReal description()
  {
