...
public final class ARBQ1BiquadLPFO8MultiDemo
{
  private ARBQ1BiquadLPFO8MultiDemo()
  {
    ...
    throws Exception
  {
    ...
    try (var stream = ARBQ1BiquadLPFO8MultiDemo.class.getResourceAsStream(
    ...
    for (final var c : cutoffs) {
      ...
      freqStats.save("/tmp/lpf8bw_cutoff_%s.properties".formatted(c));
    }
