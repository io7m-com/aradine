...
public enum ARIJ1ParameterNumberDefinition
  implements SjDefinitionProviderType
{
  ...
  PARAMETER_NUMBER_DEFINITION;

  @Override
  public String typeName()
  {
    return ARI1JParameterNumber.class.getSimpleName();
  }
    ...
    final SjGeneratorConfiguration configuration)
  {
    return () -> {
      ...
      object.put("description", "A parameter number.");
