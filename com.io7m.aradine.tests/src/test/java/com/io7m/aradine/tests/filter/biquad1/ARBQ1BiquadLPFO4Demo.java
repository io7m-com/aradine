...
public final class ARBQ1BiquadLPFO4Demo
{
  private ARBQ1BiquadLPFO4Demo()
  {
    ...
    throws Exception
  {
    ...
    try (var stream = ARBQ1BiquadLPFO4Demo.class.getResourceAsStream(
    ...
    final var cutoffs =
      DoubleStream.iterate(0.0, operand -> operand + (0.5 / 20.0))
        .boxed()
        .limit(21)
        .toList();
