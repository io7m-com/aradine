...
/**
 * An instrument that represents the system target.
 */

public final class AREnsInstrumentSystemTarget
    ...
    final ARInstrumentInstanceID inInstanceID)
  {
    ...
    this.description =
      new ARInstrumentDescription(
        ...
        Map.of(),
        Map.of(),
        ARInstrumentRole.AR_SYSTEM_TARGET
      );
  }
