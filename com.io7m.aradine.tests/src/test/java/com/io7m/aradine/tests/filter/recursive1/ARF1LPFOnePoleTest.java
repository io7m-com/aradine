...
public final class ARF1LPFOnePoleTest
{
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.0.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.03125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.25.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.5.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_0.75.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/recursive1/lpf1_cutoff_1.0.properties");
  }
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_1.0.properties",
        inputSample.sampleRate()
      );
