...
/**
 * A control event to set the value of an integer parameter.
 *
...
public record ARI1ControlEventParameterSetInteger(
  ...
  implements ARI1ControlEventParameterSetType
{
  ...
  public ARI1ControlEventParameterSetInteger
  {
  ...
  public String toString()
  {
    return String.format(
      "[ARI1ControlEventParameterSetInteger [Time %d] %s [Value %d]]",
