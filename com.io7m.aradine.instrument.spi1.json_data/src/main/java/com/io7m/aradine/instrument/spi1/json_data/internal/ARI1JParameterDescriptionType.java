...
@JsonSubTypes({
  @JsonSubTypes.Type(
    value = ARI1JParameterDescriptionInteger.class,
    name = "ParameterInteger"
  ),
  @JsonSubTypes.Type(
    value = ARI1JParameterDescriptionReal.class,
    name = "ParameterReal"
  ),
  @JsonSubTypes.Type(
    value = ARI1JParameterDescriptionSampleMap.class,
    name = "ParameterSampleMap"
  )
})
