...
public final class ARInventoryDBFactory
{
  private static final Logger LOG =
    LoggerFactory.getLogger(ARInventoryDBFactory.class);

  private static final String DATABASE_APPLICATION_ID =
    "com.io7m.aradine.inventory";
  ...
  private static ARInventoryDB connect(
    final Path file)
  {
    ...
    return new ARInventoryDB(dataSource);
  }
    ...
    throws ARInventoryException
  {
    ...
    try (var ignored1 = resources) {
      ...
      try (var stream = ARInventoryDBFactory.class.getResourceAsStream(
        "/com/io7m/aradine/inventory/internal/Database.xml")) {
      ...
      try (var connection = dataSource.getConnection()) {
        ...
        new TrExecutors().create(
          new TrExecutorConfiguration(
            ARInventoryDBFactory::schemaVersionGet,
            ARInventoryDBFactory::schemaVersionSet,
  ...
  private static ARInventoryException wrapException(
    final Exception e)
  {
  ...
  {
    return "[ARInventoryDBFactory 0x%s]"
