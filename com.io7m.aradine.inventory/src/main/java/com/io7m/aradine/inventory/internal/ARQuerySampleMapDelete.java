...
enum ARQuerySampleMapDelete
  implements ARQuerySampleMapDeleteType, ARDBQueryProviderType
{
  INSTANCE;

  private static final String QUERY_TEXT = """
    DELETE FROM inventory_sample_maps
  ...
  {
    return ARQuerySampleMapDeleteType.class;
  }
