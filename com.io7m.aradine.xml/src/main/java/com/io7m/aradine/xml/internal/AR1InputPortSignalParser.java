...
public final class AR1InputPortSignalParser
  implements BTElementHandlerType<Object, ARInstrumentInputPortSignalDefinition>
{
  private final ARInstrumentInputPortSignalDefinition.Builder metadata;

  public AR1InputPortSignalParser(
    final BTElementParsingContextType context)
  {
    this.metadata = ARInstrumentInputPortSignalDefinition.builder();
  }
  ...
  @Override
  public ARInstrumentInputPortSignalDefinition onElementFinished(
    final BTElementParsingContextType context)
  {
