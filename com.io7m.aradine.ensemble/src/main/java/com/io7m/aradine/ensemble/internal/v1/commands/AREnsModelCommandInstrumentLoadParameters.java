...
/**
 * Parameters for the instrument load command.
 *
 * @param instanceID   The instrument instance ID
 * @param instrumentID The instrument ID
 */

public record AREnsModelCommandInstrumentLoadParameters(
  ARInstrumentInstanceID instanceID,
  ARInstrumentID instrumentID)
  implements AREnsModelCommandParametersType
{
  /**
   * Parameters for the instrument load command.
   *
  ...
  public AREnsModelCommandInstrumentLoadParameters
  {
