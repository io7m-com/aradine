...
public final class ARF1LPFOnePoleTest
{
  private static final Logger LOG =
    LoggerFactory.getLogger(ARF1LPFOnePoleTest.class);
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_0.properties",
        this.noise.sampleRate()
      );
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_03125.properties",
        this.noise.sampleRate()
      );
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_0125.properties",
        this.noise.sampleRate()
      );
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_025.properties",
        this.noise.sampleRate()
      );
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_05.properties",
        this.noise.sampleRate()
      );
    ...
    throws Exception
  {
    ...
    final var expectedStats =
      ARTestFrequencyAnalysis.loadFrequencyAnalysis(
        "filter/recursive1/lpf1_cutoff_075.properties",
        this.noise.sampleRate()
      );
