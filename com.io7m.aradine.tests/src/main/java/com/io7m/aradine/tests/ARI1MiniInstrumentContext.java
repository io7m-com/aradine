...
public final class ARI1MiniInstrumentContext
  implements ARI1InstrumentContextType, AutoCloseable
{
  private static final Logger LOG =
    LoggerFactory.getLogger(ARI1MiniInstrumentContext.class);
  ...
  private ARI1MiniInstrumentContext(
  ...
  public static ARI1MiniInstrumentContext create(
    ...
    throws Exception
  {
    ...
    return new ARI1MiniInstrumentContext(
      closeables,
