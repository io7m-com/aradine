...
/**
 * An SPI1 adapter for a core API integer parameter. This wraps a core
 * parameter and exposes the API required by SPI1 instruments.
 */

public final class AREnsSPI1ParameterIntegerAdapter
  implements ARI1ParameterIntegerType
{
  private final AREnsSPI1InstrumentContextAdapter context;
  private final AREnsParameterInteger parameter;
  ...
  public AREnsSPI1ParameterIntegerAdapter(
    final AREnsSPI1InstrumentContextAdapter inContext,
    final AREnsParameterInteger inParameter)
  {
    this.context =
