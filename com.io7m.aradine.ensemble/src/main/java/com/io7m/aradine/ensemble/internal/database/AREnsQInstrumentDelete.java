...
public enum AREnsQInstrumentDelete
  implements AREnsQInstrumentDeleteType, ARDBQueryProviderType
{
  /**
   * Delete an instrument.
   */
  ...
  private static final String QUERY_TEXT = """
    DELETE FROM instruments WHERE instrument_instance_id = $1
    """;

  @Override
  public Class<?> queryInterface()
  {
    return AREnsQInstrumentDeleteType.class;
  }

  @Override
  public AREnsQInstrumentDeleteType queryInstance()
  {
    return this;
  }
