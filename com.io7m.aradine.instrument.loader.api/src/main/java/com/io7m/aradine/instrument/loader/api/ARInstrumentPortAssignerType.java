...
/**
 * A function to assign unique ID values to
 */

public interface ARInstrumentPortAssignerType
{
  /**
   * Assign a unique ID to the given port number on the given instrument.
   *
