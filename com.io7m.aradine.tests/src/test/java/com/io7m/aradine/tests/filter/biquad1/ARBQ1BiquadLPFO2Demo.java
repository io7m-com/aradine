...
public final class ARBQ1BiquadLPFO2Demo
{
  private ARBQ1BiquadLPFO2Demo()
  {
    ...
    throws Exception
  {
    ...
    try (var stream = ARBQ1BiquadLPFO2Demo.class.getResourceAsStream(
    ...
    for (final var c : cutoffs) {
      final var f = new ARBQ1BiquadLPFO2();
