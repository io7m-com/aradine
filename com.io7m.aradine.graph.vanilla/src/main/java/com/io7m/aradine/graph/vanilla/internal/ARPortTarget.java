...
import com.io7m.aradine.graph.api.ARAudioGraphPortTargetType;
import com.io7m.aradine.graph.api.ARAudioGraphType;
import com.io7m.aradine.instrument.metadata.ARInstrumentPortID;

public abstract class ARPortTarget
  extends ARPort implements ARAudioGraphPortTargetType
{
  public ARPortTarget(
