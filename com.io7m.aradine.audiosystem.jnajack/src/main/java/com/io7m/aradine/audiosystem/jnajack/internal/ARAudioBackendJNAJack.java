...
import com.io7m.aradine.api.audiosystem.ARAudioSystemEventPortConnected;
import com.io7m.aradine.api.audiosystem.ARAudioSystemEventPortDisconnected;
import com.io7m.aradine.api.audiosystem.ARAudioSystemEventProcessingError;
import com.io7m.aradine.api.audiosystem.ARAudioSystemEventType;
import com.io7m.aradine.api.audiosystem.ARAudioSystemEventXRun;
...
/**
 * A {@code jnajack} audio system backend.
 */

public final class ARAudioBackendJNAJack
  implements ARAudioSystemBackendType
{
  private static final RDottedName NAME =
    new RDottedName("com.io7m.aradine.audiosystem.jnajack");

  private static final Logger LOG =
    LoggerFactory.getLogger(ARAudioBackendJNAJack.class);
  ...
  public static ARAudioSystemBackendType create(
    final ARAudioSystemAttributes attributes,
    final ARAudioBackendJNAJackConfiguration configuration)
    throws ARException
  {
    ...
    try {
      ...
      resources.add(() -> {
        LOG.trace("Deactivating Jack client...");
        client.deactivate();
      });
      return system;
  ...
  /**
   * Determine if this backend is supported.
   *
   * @param configuration The configuration
   *
   * @return {@code true} iff the backend is supported
   *
  ...
  {
    private final ARAudioBackendJNAJack system;

    ARPortConnectionCallback(
      final ARAudioBackendJNAJack inSystem)
    {
      this.system =
