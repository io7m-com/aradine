...
/**
 * Pop a record from the undo stack.
 */

public enum AREnsQUndoPop
  implements AREnsQUndoPopType, ARDBQueryProviderType
{
  /**
   * Pop a record from the undo stack.
   */
  ...
  {
    return AREnsQUndoPopType.class;
  }

  @Override
  public AREnsQUndoPopType queryInstance()
  {
    return this;
  }
