...
public final class AREnsParameterSampleMap
  implements AREnsParameterType
{
  private final AREnsInstrumentContext context;
  private final ARParameterDescriptionSampleMap description;
  private final Int2ObjectRBTreeMap<ARSampleMapInstanceID> valueByTime;
  ...
  private ARSampleMapInstanceID valueAtPeriodStart;
  ...
  private ARSampleMapInstanceID valueAtPeriodEnd;
  ...
  public AREnsParameterSampleMap(
    final AREnsInstrumentContext inContext,
    final ARParameterDescriptionSampleMap inDescription,
    final ARSampleMapInstanceID valueDefault)
  {
    this.context =
    ...
    this.valueByTime = new Int2ObjectRBTreeMap<>();
  ...
  @Override
  public ARParameterDescriptionSampleMap description()
  {
  ...
  public ARSampleMapInstanceID value(
