...
public final class ARInventoryDB
  implements ARDBType
{
  private static final Logger LOG =
    LoggerFactory.getLogger(ARInventoryDB.class);
  ...
  public static ARInventoryDB createDatabase(
    final Path file)
    throws ARException
  {
    Objects.requireNonNull(file, "file");
    return createDatabase(file, ARInventoryDBQueries.queries());
  }
    ...
    throws ARException
  {
    ...
    try {
      ...
      try (var connection = (SQLiteConnection) dataSource.getConnection()) {
        ...
        new TrExecutors().create(
          new TrExecutorConfiguration(
            ARInventoryDB::schemaVersionGet,
            ARInventoryDB::schemaVersionSet,
            event -> {
            },
            revisions,
      ...
      return new ARInventoryDB(dataSource, queries);
  ...
  {
    return ARInventoryDB.class.getResourceAsStream(
  ...
  {
    private final ARInventoryDB db;
    private final Connection connection;

    AREnsDBConnection(
      final ARInventoryDB inDb,
