...
public interface AREnsQPortConnectionListType
  extends ARDBQueryType<AREnsQPortConnectionListType.Parameters, List<ARPortConnection>>
{
  /**
   * The parameters.
   *
  ...
  record Parameters(
    Optional<ARPortConnection> start,
    int limit)
  {
    /**
     * The parameters.
