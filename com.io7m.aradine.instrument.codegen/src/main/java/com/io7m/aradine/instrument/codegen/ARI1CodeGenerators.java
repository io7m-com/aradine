  ...
  implements ARI1CodeGeneratorFactoryType
{
  ...
  public ARI1CodeGenerators()
  {

  }

  @Override
  public ARI1CodeGeneratorType createCodeGenerator(
    final ARI1CodeGeneratorParameters parameters)
  {
    return new ARI1CodeGenerator(parameters);
  }
}
