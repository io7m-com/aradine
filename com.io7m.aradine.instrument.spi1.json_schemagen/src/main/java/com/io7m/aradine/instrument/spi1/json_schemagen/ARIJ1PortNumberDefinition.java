...
public enum ARIJ1PortNumberDefinition
  implements SjDefinitionProviderType
{
  ...
  PORT_NUMBER_DEFINITION;

  @Override
  public String typeName()
  {
    return ARI1JPortNumber.class.getSimpleName();
  }
    ...
    final SjGeneratorConfiguration configuration)
  {
    return () -> {
      ...
      object.put("description", "A port number.");
      object.put("minimum", 0);
      object.put("maximum", 4294967295L);
      return object;
    };
  }
}
