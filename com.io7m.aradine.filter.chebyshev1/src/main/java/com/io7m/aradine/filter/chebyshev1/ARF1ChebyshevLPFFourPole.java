...
/**
 * <p>A recursive four-pole low pass Chebyshev filter.
 * Filter instances are stateful (they store the most recently processed output
 * frames) and therefore each instance should only be used on a single audio
 * stream.</p>
 *
 * @see "https://www.w3.org/TR/audio-eq-cookbook/"
 */

public final class ARF1ChebyshevLPFFourPole
{
  ...
  public ARF1ChebyshevLPFFourPole()
  {
    this.cutoff = 1.0;
    this.reset();
  }
  ...
  {
    /*
     * Apply the two two-pole filters in series.
     */

    double out0;

    {
      final var co = this.coefficients.poleCoefficients().get(0);
      final var t0 = co.a0() * input;
      final var t1 = co.a1() * this.input_m1;
      final var t2 = co.a2() * this.input_m2;
      final var t3 = co.b1() * this.output_m1;
      final var t4 = co.b2() * this.output_m2;
      out0 = t0 + t1 + t2 + t3 + t4;
    }
    ...
    {
      final var co = this.coefficients.poleCoefficients().get(1);
      final var t0 = co.a0() * out0;
      final var t1 = co.a1() * this.input_m1;
      final var t2 = co.a2() * this.input_m2;
      final var t3 = co.b1() * this.output_m1;
      final var t4 = co.b2() * this.output_m2;
