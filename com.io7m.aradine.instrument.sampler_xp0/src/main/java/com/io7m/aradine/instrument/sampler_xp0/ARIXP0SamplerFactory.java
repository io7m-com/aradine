...
package com.io7m.aradine.instrument.sampler_xp0;

import com.io7m.aradine.instrument.sampler_xp0.internal.ARIXP0Sampler;
  ...
  implements ARI1InstrumentFactoryType
{
  ...
  {
    return ARIXP0SamplerFactory.class.getResourceAsStream(
      "/com/io7m/aradine/instrument/sampler_xp0/internal/instrument.json"
    );
  }
