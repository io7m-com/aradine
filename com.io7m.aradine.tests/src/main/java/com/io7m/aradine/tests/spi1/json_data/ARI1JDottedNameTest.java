...
public final class ARI1JDottedNameTest
{
  @Property
    ...
    final @ForAll RDottedName name1)
  {
    assertEquals(
      ...
      new ARI1JDottedName(name0.value())
        .compareTo(new ARI1JDottedName(name1.value()))
    );
  }
    ...
    final @ForAll RDottedName name)
  {
    Assertions.assertEquals(
      name,
      new RDottedName(new ARI1JDottedName(name.toString()).toString())
    );
  }
