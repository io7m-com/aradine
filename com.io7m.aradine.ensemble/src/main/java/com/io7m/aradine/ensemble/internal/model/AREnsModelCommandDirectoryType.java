...
/**
 * The type of model command directories.
 */

public interface AREnsModelCommandDirectoryType
{
  /**
   * Find a suitable command for the given state.
   *
   * @param record The command record
  ...
  lookupByCommandRecord(AREnsModelCommandRecord record);
}
