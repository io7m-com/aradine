...
public final class ARBQ1BRF02Test
{
  private static void runFilter(
    final ARNoiseSample sample,
    final ARBQ1BiquadBRFO2 filter,
    final String name)
    throws Exception
  {
  ...
  public void testFilter0_0(
    ...
    throws Exception
  {
    final var filter = new ARBQ1BiquadBRFO2();
    filter.setCutoff(0.0);

    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.0.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.015625.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.0078125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.00390625.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.03125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.125.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.25.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.25_q3.properties");
  }
    ...
    throws Exception
  {
    ...
    runFilter(sample, filter, "filter/biquad1/brf2_cutoff_0.5.properties");
  }
    ...
    throws Exception
  {
    ...
    try {
      ...
      final var filterForAll = new ARBQ1BiquadBRFO2();
      filterForAll.setCutoff(cutoff);

      final var filterForBlocks = new ARBQ1BiquadBRFO2();
