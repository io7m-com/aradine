...
/**
 * The attributes of the current audio system.
 */

public interface ARAudioSystemAttributesType
{
  /**
   * @return The current audio system buffer size, in frames
   */

  AttributeReadableType<Integer> bufferSize();

  /**
   * @return The current audio system sampling rate, in hz
   */
