...
public final class ARBQ1BiquadLPFO4MultiDemo
{
  private ARBQ1BiquadLPFO4MultiDemo()
  {
    ...
    throws Exception
  {
    ...
    try (var stream = ARBQ1BiquadLPFO4MultiDemo.class.getResourceAsStream(
    ...
    for (final var c : cutoffs) {
      final var f = new ARBQ1BiquadLPFBWO4();
      ...
      freqStats.save("/tmp/lpf4bw_cutoff_%s.properties".formatted(c));
    }
