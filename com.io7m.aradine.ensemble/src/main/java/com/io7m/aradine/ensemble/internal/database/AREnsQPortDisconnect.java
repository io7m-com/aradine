...
public enum AREnsQPortDisconnect
  implements AREnsQPortDisconnectType, ARDBQueryProviderType
{
  /**
   * Disconnect a port.
   */
  ...
  private static final String QUERY_TEXT = """
    DELETE FROM port_connections
      WHERE port_connections.port_connection_source = $1
        AND port_connections.port_connection_target = $2
    """;

  @Override
  public Class<?> queryInterface()
  {
    return AREnsQPortDisconnectType.class;
  }

  @Override
  public AREnsQPortDisconnectType queryInstance()
  {
    return this;
  }
