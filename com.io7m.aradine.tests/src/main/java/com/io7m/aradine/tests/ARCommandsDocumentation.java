...
public final class ARCommandsDocumentation
{
  private ARCommandsDocumentation()
  {
    ...
    final QCommandXS xs)
  {
    try {
      ...
      final var path =
        Paths.get("/tmp/scmd-%s.xml".formatted(hyphenated));
    ...
    final QCommandXS xs)
  {
    try {
      ...
      final var path =
        Paths.get("/tmp/scmd-%s-parameters.xml".formatted(hyphenated));
