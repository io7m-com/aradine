...
/**
 * <p>A biquad band-reject filter of order 8, implemented as two biquad filters in
...
public final class ARBQ1BiquadBRFBWO8 implements ARBQ1BiquadType
{
  private final ARBQ1BiquadBRFO2 stage0;
  private final ARBQ1BiquadBRFO2 stage1;
  private final ARBQ1BiquadBRFO2 stage2;
  private final ARBQ1BiquadBRFO2 stage3;

  /**
   * Create a new filter.
   */

  public ARBQ1BiquadBRFBWO8()
  {
    this.stage0 =
      new ARBQ1BiquadBRFO2();
    this.stage1 =
      new ARBQ1BiquadBRFO2();
    this.stage2 =
      new ARBQ1BiquadBRFO2();
