...
/**
 * Push a record onto the undo stack.
 */

public enum AREnsQUndoPush
  implements AREnsQUndoPushType, ARDBQueryProviderType
{
  /**
   * Push a record onto the undo stack.
   */
  ...
  {
    return AREnsQUndoPushType.class;
  }

  @Override
  public AREnsQUndoPushType queryInstance()
  {
    return this;
  }
