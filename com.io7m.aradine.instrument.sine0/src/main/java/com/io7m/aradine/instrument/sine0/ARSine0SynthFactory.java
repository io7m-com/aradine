...
import com.io7m.aradine.instrument.sine0.internal.Parameters;
import com.io7m.aradine.instrument.sine0.internal.Ports;
import com.io7m.aradine.instrument.sine0.internal.ARSine0Synth;
...
/**
 * A factory of monophonic synths.
 */

public final class ARSine0SynthFactory
  implements ARI1InstrumentFactoryType
{
  ...
  {
    return ARSine0SynthFactory.class.getResourceAsStream(
      "/com/io7m/aradine/instrument/sine0/internal/instrument.json"
    );
  }
