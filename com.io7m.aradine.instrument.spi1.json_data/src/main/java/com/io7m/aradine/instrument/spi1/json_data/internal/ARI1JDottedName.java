...
public record ARI1JDottedName(String value)
  implements Comparable<ARI1JDottedName>
{
  /**
   * A standard restricted dotted name.
   *
  ...
  public int compareTo(
    final ARI1JDottedName o)
  {
    return Comparator.comparing(ARI1JDottedName::value).compare(this, o);
  }
}
